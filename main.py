...
__CHANNEL_USERNAME__ = "LoCPM"
__GROUP_USERNAME__   = "LoCPMChat"
...
def banner(console):
    ...
    brand_name = figlet_format('LoCPM', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ Owner Of This Tool Is  LoCPM @SampaioCPM[/bold green]: Car Parking Multiplayer Hacking Tool.")

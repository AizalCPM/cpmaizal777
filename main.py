...
×××××××××× Ayyan Cpm Tools ××××××××××
       Car Parking Multiplayer
         ©Copyright_ A̷̢̖̥͔̥̅͋̔̈ȳ̵̙̳̣̟̝̜͎͎̀̈́̚̚y̷̹̻̱̳͔̺̘̹̓a̸̧̳̮̺̣̠͚̓͆̔͛͌͝n̸̲̼̩̰̥̪͓̲͑̑̂̀̓͒̾̈́͒͘ ̸̨̛̛̻̰̜̞̼̟͎̳̠̾̂l̵̢̢̢̜͔͇̯̀̃̉̏̌̀̕̚ͅͅͅy̵̳͈̝̋͊̆͐͌̿ñ̶̨͍̞̳̮͕̣̼̓͋͌̀̂̂͗͂ͅẍ̷̗̫́ͅ •
...
def banner():
    ...
    versi = "AyyanCPM Version: 1.02.4 || Author https://t.me/Not_Your_Ayyan

...
def banner(console):
    ...
    console.print("[bold green]♕ Car Parking Multiplayer Tool Owner Of This Tool Is @ItzAizal And @Aizal_Lynx[/bold green]: Get In Touch With Me To Buy An Unlimitied Balance.")
    ...
    console.print("[bold yellow]! Note[/bold yellow]: Logout Your Id From CPM Then Use This Tool Thank You  !.", end="\n\n")
    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if len(new_id) >= 2 and len(new_id) <= 1000 and (' ' in new_id) == False:
                ...
                if amount > 0 and amount <= 999999999999999:

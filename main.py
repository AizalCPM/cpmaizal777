...
def banner(console):
    ...
    console.print("[bold green]♕  CPMAizal [/bold green]: Car Parking Multiplayer Hacking Tool.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](01):[/cyan] [green]Increase Money ~ 100[/green]")
            console.print("[bold][cyan](02):[/cyan] [green]Increase Coins ~ 100[/green]")
            console.print("[bold][cyan](03):[/cyan] [green]King Rank ~ 100[/green]")
            console.print("[bold][cyan](04):[/cyan] [green]Change ID ~ 100[/green]")
            ...
            console.print("[bold][cyan](11):[/cyan] [green]Unlock Paid Cars ~ 100[/green]")
            console.print("[bold][cyan](12):[/cyan] [green]Unlock all Cars ~ 100[/green]")
            console.print("[bold][cyan](13):[/cyan] [green]Unlock all Cars Siren ~ 100[/green]")
            console.print("[bold][cyan](14):[/cyan] [green]Unlock w16 Engine ~ 100[/green]")
            console.print("[bold][cyan](15):[/cyan] [green]Unlock All Horns ~ 100[/green]")
            console.print("[bold][cyan](16):[/cyan] [green]Unlock Disable Damage ~ 100[/green]")
            console.print("[bold][cyan](17):[/cyan] [green]Unlock Unlimited Fuel ~ 100[/green]")
            console.print("[bold][cyan](18):[/cyan] [green]Unlock House 3 ~ 100[/green]")
            console.print("[bold][cyan](19):[/cyan] [green]Unlock Smoke ~ 100[/green]")
            console.print("[bold][cyan](20):[/cyan] [green]Change Race Wins ~ 100[/green]")
            console.print("[bold][cyan](21):[/cyan] [green]Change Race Loses ~ 100[/green]")
            console.print("[bold][cyan](22):[/cyan] [green]Clone Account ~ 500[/green]")

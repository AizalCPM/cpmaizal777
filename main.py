...
__GROUP_USERNAME__   = "CPMKINGTOOL"
...
def banner(console):
    ...
    brand_name = figlet_format('CPMCane', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ CPMCane [/bold green]: Car Parking Multiplayer Hacking Tool.")

...
def banner(console):
    ...
    brand_name = figlet_format('ToolAizal', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ CPMAizal Is The Owner Of This Tool Copyright @ItzAizal[/bold green]: Car Parking Multiplayer Hacking Tool.")

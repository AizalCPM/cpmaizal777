...
def banner(console):
    ...
    console.print("[bold green]♕ CarParking Tool CPMAizal TG ID @ItzAizal[/bold green]: Car Parking Multiplayer Tool.")
    ...
    console.print("[bold yellow]! Note[/bold yellow]: Logout Your Acc From CPM To Use The Tool  !.", end="\n\n")

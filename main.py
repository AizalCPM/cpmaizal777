...
__CHANNEL_USERNAME__ = "kaitofficialchannel"
__GROUP_USERNAME__   = "kaito_group"
...
def banner(console):
    ...
    brand_name = figlet_format('Kaito', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ Owner Of This Tool Is  CPMKaito @unlikelines[/bold green]: Car Parking Multiplayer Hacking Tool.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](11):[/cyan] [green]Unlock Paid Cars ~ 4K[/green]")
            console.print("[bold][cyan](12):[/cyan] [green]Unlock all Cars ~ 3K[/green]")
            console.print("[bold][cyan](13):[/cyan] [green]Unlock all Cars Siren ~ 2K[/green]")
